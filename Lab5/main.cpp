...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("D:/Project/OpenGL/Lab5/Content/quad.obj")) {
            return false;
        }
        
        if (!m_billboardList.Init("D:/Project/OpenGL/Lab5/Content/monster_hellknight.png")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab5/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab5/Content/normal_map.jpg");

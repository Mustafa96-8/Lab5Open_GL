...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("D:/Project/OpenGL/Lab5/Content/phoenix_ugv.md2")) {
            return false;            
        }
        
        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("D:/Project/OpenGL/Lab5/Content/jeep.obj")) {
            return false;            
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("D:/Project/OpenGL/Lab5/Content/hheli.obj")) {
            return false;            
        }
